            ...
            <Column className="w-[68%]">
              <Row className="items-center rounded-radius10 w-[92%]">
                <Row className="items-center justify-between rounded-radius10 w-[50%]">
                  <Button
                    className="font-medium lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[27%]"
                  ...
                  <Button
                    className="font-medium lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center text-gray_900 w-[31%]"
                    shape="RoundedBorder10"
                    size="lg"
                ...
                <Button
                  className="font-medium lg:ml-[167px] xl:ml-[191px] 2xl:ml-[215px] 3xl:ml-[258px] lg:text-[14px] xl:text-[16px] 2xl:text-[18px] 3xl:text-[21px] text-center w-[22%]"
                  shape="RoundedBorder10"
                  size="lg"
                  variant="FillRed300"
                >
